        ...
        public void Visualize(TrasportSystem system, Chart chart, int numberTransportStop, string variableGraph,int index)
        {
            ...
            switch (variableGraph)
            {
                case "Лучший результат":
                    this.Visualize(system.PlanRoutes[index].PlanRouteTrasnport, chart);
                    break;
                ...
                case "Алгоритм по столбцам":
                    this.Visualize(system.algorithmColumn.PlanRoutes[index].PlanRouteTrasnport, chart);
                    break;
                case "Маршрут лучший результат":
                    this.Visualize(system.PlanRoutes[index].RouteTransport, chart);
                    break;
                ...
                case "Маршрут алгоритм по столбцам":
                    this.Visualize(system.algorithmColumn.PlanRoutes[index].RouteTransport, chart);
                    break;
            }
        }
